...
<div class="breadcrumbs">
	<h1><span class="glyphicon glyphicon-list-alt"></span>Outdoor Assets</h1>
</div>
<?php
...
<div class="main col-xs-12">
	<form method="post">
		<ul class="nav navbar-nav section-menu">
			<li class="active"><a href="<?php echo site_url('load_stock/view_my_assets'); ?>">Outdoor Assets</a></li>
