...
function decline(){
  if (confirm("Are you sure you want to delete all")) {
    location.href='delete_all?all=1';
  }
  return false;
}
</script>
...
<div class="breadcrumbs">
    <h1><span class="glyphicon glyphicon-list-alt"></span>Remove Items from Auction</h1>
</div>
    ...
    <div class="table_div">
        ...
        <div class="panel panel-default" style="padding-right:30px;">
                ...
                <div class="form-group pull-right">
                    ...
                    <!--
                    	<input name="approve" onclick="approve()" type="button" class="btn btn-primary" value="Approve All">
                    	&nbsp;&nbsp;
                    	-->
                    	<input name="approve" onclick="decline()" type="button" class="btn btn-primary" value="Delete All Auctions">
                    </span>
				</div>
				...
				foreach ($mmm as $row) {
					...
					if($img_url != '' && $img_url != null && !is_null($img_url)){
 					...
 					$asset_url = site_url('load_stock/asset').'?auction_id='.$auction_id.'&ass_id='.$asset_id;
 					//href="asset?auction_id= echo $auction_id;&ass_id=<?php echo $row->ass_id;"
            	  ?>
                          ...
                          <tr>
                            ...
                            <td>
		                      ...
		                      <div class="btn-group" style="padding-left:10px;">
		                        ...
		                        <a href="<?php echo site_url('my_stock/delete?p=op_index_remove&delete=delete&asst_id='),$asset_id,'&auction_id=',$auction_id; ?>" 
		                        	class="btn btn-primary"  
		                        	data-id="<?php echo $asset_id; ?>">
		                        	<span class="glyphicon glyphicon-remove"></span> Remove Auction</a>
		                      </div>
