           ...
           <div  class="col-xs-8">
              ...
              <div class="form-group">
                <div class="input-group">
                 <a href="asset_details3" >
                  <button type="button" class="btn btn-primary"> Continue Bidding </button>
                 </a>
                 <a href="active_bids"  >
                  <button type="button" class="btn btn-primary"> Go To My Shopping Basket</button></a>
                 <a href="../navigate/index"  >
                  <button type="button" class="btn btn-primary"> Exit Auctions</button>
                 </a>
                </div>
              </div>
