        ...
        $total_watch_list = $select_query1->num_rows;
        ...
        $total_active_bids = $select_query->num_rows;
        ...
        $this->db->join('bids','bids.auction = auctions.id');
        $this->db->where("bids.bidder", $user_id );
        $this->db->where("bids.winner !=", $user_id );
        $select_query = $this->db->get();  
        ?>
        <div class="main col-xs-12" >
          ...
          <ul class="nav navbar-nav section-menu">
            ...
            <li><a href="../load_stock/active_bids">Your Active Bids<span class="badge"><?php echo $total_active_bids;?></span></a></li>
            <li><a href="../load_stock/watch_list">Watch List<span class="badge"><?php echo $total_watch_list;?></span></a></li>
