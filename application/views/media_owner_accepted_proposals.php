    ...
    <div class="main col-xs-12">
        <form method="post">
            <ul class="nav navbar-nav section-menu">
                <li class="active"><a href="../new_campaign/media_owner_accepted_proposals">Accepted Proposals</a></li>
                <li><a href="../new_campaign/media_owner_campaign_list">Proposals</a></li>
            </ul>
