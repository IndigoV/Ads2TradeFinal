          ...
          <div class="row">
            <div class="col-xs-8">
              <div id="dashboard_stats">
                <div class="row">
                  <div class="col-sm-4">
                    <a href="../load_stock/" class="stat icon1">
                      <h3><?php echo $this->session->userdata('allAssetsCount');?></h3>
                      <h4>My Assets</h4>
                      <hr>
                      <div class="row info">
                        <!--                         
                        ...
                        <div class="col-sm-12 text-right">
                          <small><span>Total Acquisition Cost:</span>R<?php echo $this->session->userdata('allAssetsValue');?></small>
                        </div>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="col-sm-4">
                     <a href="../load_stock/active_bids" class="stat icon2">
                      <h3><?php echo $this->session->userdata('allBidsCount');?></h3>
                      <h4>Active bids</h4>
                      <hr>
                      <div class="row info">
                        <div class="col-sm-4 text-left">
                          <small><span>Total:</span>R<?php echo $this->session->userdata('allBidsValue');?></small>
                        </div>
                        <div class="col-sm-8 text-right">
                          <small><span>Latest Bid Amount:</span>R<?php echo $this->session->userdata('bdLatestBid');?></small>
                        </div>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="col-sm-4">
                    <a href="../load_stock/asset_details3" class="stat icon3">
                      <h3><?php echo $this->session->userdata('allAuctionsCount');?></h3>
                      <h4>Auctions</h4>
                      <hr>
                      <div class="row info">
                        <div class="col-sm-6 text-left">
                          <small><span>Bids (<?php echo $this->session->userdata('auBidCount'); ?>):</span>
                          R<?php echo $this->session->userdata('allAuctionsValue');?></small>
                        </div>
                        <div class="col-sm-6 text-right">
                          <small><span>Latest Bid:</span>R<?php echo $this->session->userdata('auLatestBid');?></small>
                        </div>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="col-sm-4">
                    <a href="../load_stock/" class="stat icon5">
