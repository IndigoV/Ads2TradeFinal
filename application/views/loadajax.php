...
function bid_now(id){
  ...
  var disabled = '<?php echo $css_disabled; ?>';
  if(disabled!=''){
    return; //exit if this button is disabled
  }
...
function buy_now(id){
  ...
  bid =  document.getElementById('bid').value * 1;
  min =  document.getElementById('minimum').value * 1;
  if(document.getElementById('buy_now') != undefined){ 
    buy_now_amt =  document.getElementById('buy_now').value * 1;
  } else {
    buy_now_amt = -1;
  }
  auct_id =  document.getElementById('auct_id').value;
  location.href="buynow?buy_now="+buy_now_amt+"&bid="+bid+"&ass_id="+id+"&auct_id="+auct_id;
...
<div class="modal-header" style="background-color:lightgrey;">
  ...
  <h4 class="h4 modal-title" id="myModalLabel">
    <span class="h4 glyphicon glyphicon-edit"></span> Asset Details</h4>
</div>         
        ...
        <tbody>  
            ...
            <td colspan="8"><div class="form-group">
                <div class="input-group">
                   ...
                   <a href="#" onclick="modalshow3('<?php echo $row->ass_id; ?>','2')">
                      <button type="button" class="btn btn-primary">Watch Lists</button>
                    </a>
                    <a href="<?php echo site_url('load_stock/won_bids'); ?>">
                      <button type="button" class="btn btn-primary">Go To My Shopping Basket</button>
                    </a>
                    <a href="<?php echo site_url('auctions/spec_sheet?ass_id='.$a); ?>" target="_blank">
          ...
          <tr>  
            ...
            <input  name="buy_now" id="buy_now_amt" type="hidden" value="<?php echo $buy_now;?>">
                   </td>
          ...
          <tr>  
            ...
            <td>
              <a href="#" onclick="buy_now(<?php echo $row->ass_id;?>)">
                <button type="submit" class="btn btn-primary <?php echo $css_disabled; ?>" data-dismiss="modal">Buy Now</button>
              </a>
            </td>  
            <td></td>
            <td colspan="2"> 
            <a href="#" onclick="bid_now(<?php echo $row->ass_id;?>)" >
              <button type="submit" class="btn btn-primary <?php echo $css_disabled; ?>" data-dismiss="modal">Place Bid</button>
            </a>
