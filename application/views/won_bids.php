...
// My Won Bids
$bid_type = 2; //Active [1=Active, 2=Won, 3=Lost]
$myWonBids = $this->dashboard->userBids($user_id, $bid_type);
$myWonBidsCount = 0;
$myWonBidsTotal = 0;
$first_record = true;
foreach ($myWonBids as $row) {
  $myWonBidsCount++;
  $myWonBidsTotal += $row->bid;
  if($first_record){
    $myLatestWonBidAmount = $row->bid;
    $first_record = false;
  }
}
$total_won_bids = $myWonBidsCount;
