...
<page>
 ...
 if ($data['ast']){ 
    foreach ($data['ast'] as $row) { 
       ...
       //exposure time unit
       //$exposure_unit = $this->asset->getAssetExposureUnit($asset_id);
   ?>
  <table >  
        ...
        <tbody>  
          <tr>  
            ...
            <td width="40%" style="vertical-align: top;">
                 ...
                 <table cellspacing="2" style="border: 1px;border-color: black; padding-top: 1 ;width: 100%; height: 100%; float: right;border-color: gray;" >
                        ...
                        <tr>
                            <td   bgcolor="gray" colspan="2"> <font size="2" >Rates & Pricing                                
                                </font>
                            </td>
                        </tr>
          ...
          <tr>  
            ...
            <td style="vertical-align: top;"><table cellspacing="2" style="border: 1px;border-color: black; padding-top: 1 ;width: 100%; height: 100%; float: right;border-color: gray;" >
                        ...
                        <tr>
                            <td  bgcolor="gray" colspan="2"> <font size="2" >General                                
                                </font></td>
                        </tr>
                        <?php
                        $status = "";
                        /*
                        switch($row->ass_status){
                        ...
                        */
                        ?>
                        <tr><td><strong>Approval Status</strong> </td><td>: <?php echo $status; ?></td></tr>
                        <tr><td><strong>Face Count</strong></td><td>:<?php echo $faces; ?></td></tr>
                        <tr><td><strong>Restrictions</strong></td><td>:<?php echo $row->ass_restrictions; ?></td></tr>
            ...
            <table cellspacing="2" style="border: 1px;border-color: black; padding-top: 1 ;width: 100%; height: 100%; float: right;border-color: gray;" >
                        ...
                        <tr><td><strong>FootFall / Pedestrians</strong></td><td>:TBA</td></tr>
                        <tr><td> <strong>Opportunity To See(OTS)</strong></td><td>:TBA</td></tr>
                        <tr><td> <strong>Visibility Adjusted Indices(VAI)</strong></td><td>:TBA</td></tr>                      
                ...
                <table  cellspacing="2" style="border: 1px;border-color: black; padding-top: 1 ;width: 100%; height: 100%; float: right;border-color: gray;" >
                        ...
                        <tr>
                            <td  bgcolor="gray" colspan="2"> <font size="2" >Evaluation                                
                                </font>
                            </td>
                        </tr>
                        <tr><td> <strong>Exposure Time</strong> </td><td>: <?php echo '' ?></td></tr>
