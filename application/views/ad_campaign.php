...
<form method="post">
    <ul class="nav navbar-nav section-menu">
        ...
        <li class="active"><a href="../new_campaign/ad_campaigns">All Campaigns</a></li>
...
<div>
	<table class="table table-striped">
		...
		<td><?php
			if ($amai->cam_partial_availability_status == 1) {
				echo 'YES';
			} else {
				echo 'NO';
			}
		...
		<td><?php echo $amai->prs_description; ?></td>
                <td><?php if ($processed <> '1'){ ?><a href="../new_campaign/cancelRFP?id=<?php echo $amai->cam_id; ?>" class="btn btn-default"  >Cancel this RFP</a><?php } ?><input type="hidden" name="campaign_desc" id="campaign_desc"
