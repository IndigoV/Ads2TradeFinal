...
<div class="map_view">        
	<div id="map-canvas-sell" style="width:1053px;height:500px;margin-top:200px;"> Loading AdsMap... </div>
</div>
...
$('#placeBid').on('show.bs.modal', function(e) {
     ...
     var AuctionId = "<?php echo $this->input->get('auction_id')?>";
     ...
     $(e.currentTarget).find('input[name="bid_auct_id"]').val(AuctionId);
...
$('#buyNow').on('show.bs.modal', function(e) {
     ...
     //asset id
     $(e.currentTarget).find('input[name="ass_id"]').val(AssetId);
     $(e.currentTarget).find('input[name="buy_auct_id"]').val(AuctionId);
                            ...
                            <td colspan="8">
                              <div class="form-group">
                                <div class="input-group">
                                  ...
                                  <a href="<?php echo site_url('auctions/spec_sheet?ass_id=<?php echo $row->ass_id;?>'); ?>" target="_blank">
