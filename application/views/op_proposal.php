...
<form method="post">
	<ul class="nav navbar-nav section-menu">
        <li class="active"><a href="../new_campaign/proposals">Incoming Quotations</a></li>
        <li><a href="../new_campaign/accepted_proposals">Accepted Proposals</a></li>
        <li><a href="../new_campaign/campaigns">Request For Proposals</a></li>
	</ul>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach($campaignData as $campaign) { ?>
                            <tr>
                                <td><a href="../new_campaign/view_campaign_quotations?id=<?php echo $campaign->cam_id; ?>"><?php echo $campaign->cam_title; ?></a></td> <!-- onclick="RfpCampaigns.viewCampaignQuotations(<?php echo $campaign->cam_id; ?>); return false;"-->
                                <td><?php echo $campaign->advertiser_firstname . ' ' . $campaign->advertiser_surname; ?></td>
                                <td><?php echo $campaign->cam_budget; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
...
<div class="col-md-12">
    <div class="col-sm-12" id="campaign_quotations_area">
...
<div class="col-md-12">
	...
	<table class="table table-striped">
		...
		<tbody>
                    ...
                    $alreadyDown = array();
                    $arr = array();
                    //echo "<pre>". print_r($proposals, 1) . "</pre>"; exit();
                    ...
                    for($i = 0; $i < count($arr); $i++) {
                        ...
                        <tr>
                            ...
                            <tr class="<?php echo ($arr[$i]->process == '1') ? 'green_process' : ''; ?>">
                                <td><?php echo $arr[$i]->cam_title; ?><input type="hidden" name="cam_title" id="camp_title" value="<?php echo $arr[$i]->cam_title; ?>"</td>
