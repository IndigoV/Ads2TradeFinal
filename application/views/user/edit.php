<?php 
//Edit user id
$edit_user_id = $this->input->get('id');
$user_id = $this->session->userdata('user_id');
$page_title = "Editing User :: $user->use_username";
if($edit_user_id == $user_id){
    $page_title = "My Details :: $user->use_username";
} 
...
<h3 class="h4"><?php echo $page_title; ?></h3>
<?php 
if($user_type >= 3){ //operator
    $this->load->view('user/_nav', array('status' => isset($status)?$status:'', 'list' => isset($list)?$list:'')); 
}
?>
<div class="table_div">
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <div class="form-control-group">
                ...
                <?php echo form_dropdown('user_type', $user_type_options, set_value('user_type',$user->ust_id), ' class="form-control" ' . $disabled ); ?>
            </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-control-group">
                ...
                <?php echo form_dropdown('use_status', $user_status_options, $user->use_status, ' class="form-control" '. $disabled ); ?>
            </div>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-control-group">
                ...
                <?php echo form_input('use_auction_limit', $user->use_auction_limit , 'class="form-control" ' .$disabled ); ?>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-control-group">
                ...
                <?php echo form_input('use_increase_limit', $user->use_increase_limit, ' class="form-control" '. $disabled); ?>
            </div>
        </div>
