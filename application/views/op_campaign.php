...
<form method="post">
	<ul class="nav navbar-nav section-menu">
        ...
        <li class="active"><a href="../new_campaign/campaigns">New Request For Proposals</a></li>
	</ul>
...
<div>
	<table class="table table-striped">
		...
		<td>
	       ...
	       <?php if ($this->session->userdata('user_type') == 3 && $amai->pro_status_id == 1): echo "Proposal Received From Advertiser";
			else: echo $amai->prs_description; 
		   endif ?>
