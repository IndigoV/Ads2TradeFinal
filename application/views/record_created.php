  ...
  -->
    ...
    <div class="modal-header" style="background-color:lightgrey;">
      ...
      <h4 class="h4 modal-title" id="myModalLabel">
        <span class="h4 glyphicon glyphicon-edit"></span> Record Captured Successfully</h4>
    </div> 
              ...
              <div class="form-group">
                <div class="input-group">
                  <a href="<?php echo site_url('load_stock/asset_details3'); ?>">
                    <button type="button" class="btn btn-primary">Create Another Transaction</button>
                  </a>
                  &nbsp;
                  <a href="<?php echo site_url('load_stock/asset_details3'); ?>">
                    <button type="button" class="btn btn-primary">Exit Transaction</button>
                  </a>
                </div>
              </div>
